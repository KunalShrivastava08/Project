...
<body>
	...
	<div>
		<a href="..\pages\SelectAndViweSite.jsp"><button type="button"
				class="btn btn-primary btn-sm">For search page click here</button></a> <a
			href="..\pages\buyer.jsp"><button type="button"
				class="btn btn-primary btn-sm">Go to Buyer page? Click here
			</button></a>
